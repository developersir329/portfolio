...
function Eduction() {
  return (
    <div className='eduction-container'>
        ...
        <h1>Diploma: <span className='psn'>Electronics Engineering</span></h1>
        <h1>College: <span className='psn'> Govenment Politechnic Manikpur Chitrkoot(Bteup)</span></h1>
        <h1>Passed: <span className='psn'>First Devition</span></h1>
        <h1> Prsent: <span className='psn'>75%</span></h1>
        </div>
        <div className='heigh-school'data-aos="zoom-in" data-aos-duration="1000">
